...
import { FlatList, View, Dimensions, Text, StyleSheet, Image, TouchableOpacity, TextInput, ScrollView, SafeAreaView } from "react-native";
...
import { EvilIcons, Ionicons, FontAwesome, AntDesign } from 'react-native-vector-icons';
import { useNavigation } from '@react-navigation/native';
import AllServicesSecond from './Screens/AllServicesSecond';
...
const TopTabThird = () => {
    ...
    return (
        ...
        <SafeAreaView style={{ flex: 1, top: 32, backgroundColor: 'white' }}>
            <TouchableOpacity onPress={() => navigation.navigate('TopTabFourth')} style={{ width: Dimensions.get('window').width * 0.1, }}><AntDesign name='arrowleft' size={40} style={{ top: 3, left: 5 }} /></TouchableOpacity>
            <Tab.Navigator
            ...
            >
                ...
                <Tab.Screen name="ALL SERVICES" component={AllServicesSecond} />
            ...
            <View style={{ backgroundColor: '#147fdc', height: 123, justifyContent: 'center' }}>
                ...
                <Text style={{ color: 'white', fontSize: 20, bottom: 35, left: 160, }}>0 Items Added</Text>
